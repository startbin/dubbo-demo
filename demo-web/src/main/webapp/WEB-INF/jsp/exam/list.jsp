...
<body>
	<div class="easyui-layout" data-options="fit:true"> 
    	<div id="north" title="搜索条件"  style="background-color: #E0ECFF;height:60px;"
	       ...
	       <form id="searchForm" name="searchForm" action="<%=contextPath%>/exam/list_json" method="post">
              <table >
		         <tr>
		            <th>名称：</th>
    ...
    <script type="text/javascript">
		$(function(){
			$("#examList").datagrid({
			    ...
			    striped: true, 
			    singleSelect:true,
			    url:'<%=contextPath%>/exam/list_json',
                columns:[[  
			...
			if('${msg}'){
				$.messager.show({title : 'Success',msg : '${msg}'});
			}
		});
					...
					$.ajax({
						...
						success : function(data) {
							if(data){
								...
								$.messager.show({title : 'Success',msg : '成功'});
							}else{
